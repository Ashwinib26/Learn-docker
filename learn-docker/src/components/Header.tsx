    ...
    <header className="w-full bg-rose-900 text-rose-100 shadow-md border-b border-rose-200">
      <div className="flex items-center justify-between px-6 py-4 max-w-screen-xl mx-auto">
        ...
        <nav className="flex gap-6 text-sm sm:text-base font-medium items-center">
          <Link href="/Guide" className="hover:underline hover:text-rose-700 transition">
            Guide
          </Link>
          <Link href="/Visualizations" className="hover:underline hover:text-rose-700 transition">
            Visuals
          </Link>
        </nav>
      </div>
